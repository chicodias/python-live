...
To do this, you need to lowercase and hyphenate each color in the following list.
You cannot edit the values in the list by hand as your boss is wanting a loop that can be applied to any set of crayola boxes in the future.
"""
